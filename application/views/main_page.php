    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active"><a href="<?php echo base_url('Crud')?>"><i class="glyphicon glyphicon-save-file"></i><span>Tambah Pegawai</span></a></li>
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <hr>
                <form class="form-horizontal" action="<?php echo base_url() . 'Crud/insert'; ?>" method="post">
                    <?php if ($this->session->flashdata('pesan') <> '') { ?>
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="kelamin">
                                    ...
                                    <?php foreach ($kelamin as $kel) :
                                        echo "<option value='$kel->id_kelamin'>$kel->nama_kelamin</option>";
                                    endforeach; ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="posisi">
                                    ...
                                    <?php foreach ($posisi as $pos) :
                                        echo "<option value='$pos->id_posisi'>$pos->nama_posisi</option>";
                                    endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8">
                                <input type="hidden" class="form-control" name="idpeg" value="<?php echo random(35)?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-8">
