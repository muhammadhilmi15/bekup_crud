        ...
        <div class="row">
          <div class="col-md-11">
            ...
            <?php if ($this->session->flashdata('pesan') <> '') { ?>
              ...
              <?php } ?>
              <table id="tabel_pegawai" class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    <th>ID Pegawai</th>
                    <th>Nama</th>
                  ...
                  <?php foreach ($pegawai as $u) : ?>
                    <tr>
                      ...
                      <td style="width:80px;">
                        ...
                        <a href="<?= base_url() ?>Crud/hapus/<?= $u->id_pegawai ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
